...
@WebServlet(name = "AtualizarTimeServlet", urlPatterns = {"/adm/AtualizarTimeServlet"})
...
public class AtualizarTimeServlet extends HttpServlet {
    ...
    protected void service (HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException{
        ...
        boolean sucesso = dao.atualizar(id, nome, nacionalidade);
        
        request.setAttribute("msg", sucesso ? "Time atualizado com sucesso!" : "Erro ao atualizar time!" );
