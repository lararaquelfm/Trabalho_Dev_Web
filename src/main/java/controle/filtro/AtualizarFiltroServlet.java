...
@WebServlet(name = "AtualizarFiltroServlet", urlPatterns = {"/AtualizarFiltro"})
public class AtualizarFiltroServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        boolean sucesso = dao.atualizar(id, nome, checked);
